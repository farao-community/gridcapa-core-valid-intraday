...
class VerticesUtilsTest {
    ...
    void projectVertices() {
        ...
        //      => delta = 2/3
        final List<Vertex> projected = VerticesUtils.getSelectedProjectedVertices(List.of(vertex1), branches, getTestCoreHubs(), x -> true);
        vertex1.coordinates()
        ...
        final List<Vertex> unprojected = VerticesUtils.getSelectedProjectedVertices(List.of(vertex2), branches, getTestCoreHubs(), x -> true);
        ...
        final List<Vertex> unprojected2 = VerticesUtils.getSelectedProjectedVertices(List.of(vertex2), getTestBranchWithZeros(), getTestCoreHubs(), x -> true);
